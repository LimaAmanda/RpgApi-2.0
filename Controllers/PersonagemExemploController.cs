...
namespace RpgApi.Controllers
{
    ...
    {
         //Criação de uma lista já adicionando os objetos
        ...
        [HttpGet("GetAll")] //Rota "GetAll" para o método chamado "Get"
        public IActionResult Get() 
        {
            return Ok(personagens);
        }        

        [HttpGet("GetSingleAula4")] //Rota
        public IActionResult GetSingle()//Nome do método (GetSingle)
        {
            return Ok(personagens[2]);
        }
        //http://localhost:5000/PersonagemExemplo/GetSingleAula4
        //- http://localhost:5000 --> Endereço da API
        //- PersonagemExemplo --> Controller
        //- GetSingleAula4 --> Rota
